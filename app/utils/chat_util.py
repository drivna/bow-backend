...
def send_reply_to_user(
    user_message: str, file_content: str, user_id: str, chat_id: str, file_id: Optional[str] = None
):
    ...
    if file_id is not None:
        file_chat_entry = FileChatModel(user_id=user_id, chat_id=chat_id, file_id=file_id)
